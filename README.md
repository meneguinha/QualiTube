...
You are free to share and adapt the software under the condition that you provide proper attribution, use it only for non-commercial purposes, and distribute any modifications under the same license. See the [LICENSE](LICENSE) file for details.
